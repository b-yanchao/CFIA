...
from ultralytics.nn.modules.block import PSA_A, DySample
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    global c3, c4, c_2, c1, c_f1, c_f2, c_f3
    import ast
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
            ...
            if m in [DSIEM, SCDownWave_fpn]:
                c1, c2 = ch[f[0]], args[0]
            elif m == multiscale_upfusion:
                c1, c_2, c3, c4 = ch[f[0]], ch[f[1]], ch[f[2]], ch[f[3]]
            else:
                c1, c2 = ch[f], args[0]
